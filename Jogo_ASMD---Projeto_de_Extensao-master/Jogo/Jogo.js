...
const Rodar_operacao_1 = (dado_1, dado_2) => {
  ...
  if (random == 1) {
    document.getElementById("operacao_1").innerHTML =
      "<img src='ponteiro_soma.png'/>";
  } else if (random == 2) {
    document.getElementById("operacao_1").innerHTML =
      "<img src='ponteiro_subtracao.png'/>";
  } else if (random == 3) {
    document.getElementById("operacao_1").innerHTML =
      "<img src='ponteiro_multiplicacao.png'/>";
  } else if (random == 4) {
    document.getElementById("operacao_1").innerHTML =
      "<img src='ponteiro_divisao.png'/>";
  }
...
const Rodar_operacao_2 = (resposta_1, dado_3) => {
  ...
  if (random == 1) {
    document.getElementById("operacao_2").innerHTML =
      "<img src='ponteiro_soma.png'/>";
  } else if (random == 2) {
    document.getElementById("operacao_2").innerHTML =
      "<img src='ponteiro_subtracao.png'/>";
...
const Iniciar_jogo = () => {
  ...
  if (vez_jogador == 1) {
    document.querySelector("#tampa").innerHTML =
      "<img src='tampa-de-garrafa-1.png'/>";
  }
};
...
const verifcar_resposta = () => {
  ...
  const quantidade_jogadores = parseInt(
    document.getElementById("quantidade_j").innerHTML
  );
...
const vez = () => {
  ...
  switch (quantidade_jogadores) {
    case 1:
      if (jogador_1 < 10) {
        document.getElementById("tampa").innerHTML =
          "<img src='tampa-de-garrafa-1.png'/>";
    ...
    case 2:
      if (vez_jogador == 1) {
        if (jogador_2 < 10) {
          vez_jogador = 2;
          document.getElementById("tampa").innerHTML =
            "<img src='tampa-de-garrafa-2.png'/>";
        }
      } else if (vez_jogador == 2) {
        if (jogador_1 < 10) {
          vez_jogador = 1;
    ...
    case 3:
      if (vez_jogador == 1) {
        if (jogador_2 < 10) {
          ...
          vez_jogador = 3;
          document.getElementById("tampa").innerHTML =
            "<img src='tampa-de-garrafa-3.png'/>";
        }
      } else if (vez_jogador == 2) {
        if (jogador_3 < 10) {
          vez_jogador = 3;
    ...
    case 4:
      if (vez_jogador == 1) {
        if (jogador_2 < 10) {
          ...
          vez_jogador = 4;
          document.getElementById("tampa").innerHTML =
            "<img src='tampa-de-garrafa-4.png'/>";
        }
      } else if (vez_jogador == 2) {
        if (jogador_3 < 10) {
          vez_jogador = 3;
    ...
    case 5:
      if (vez_jogador == 1) {
        if (jogador_2 < 10) {
          ...
          vez_jogador = 5;
          document.getElementById("tampa").innerHTML =
            "<img src='tampa-de-garrafa-5.png'/>";
        }
      } else if (vez_jogador == 2) {
        if (jogador_3 < 10) {
          vez_jogador = 3;
...
const mostrar_pontos_placar = () => {
  const tabela_placar_celulas = document.querySelectorAll(
    "#placar tbody tr td"
  );
...
>>>>>>> bf3227fb79f6e449a48b9d6bf47050cf1f5094d7
...
const movimentacao_tampinhas = () => {
  ...
  switch (quantidade_jogadores) {
    ...
    case 2:
      ...
      if (jogador_2 == 1) {
        //não esta funcionando essa parte
...
btn_Iniciar.addEventListener("click", () => {
  ...
  if (nomes[0] == "") {
    ...
    const tampinhas_jogadores = document.querySelector(
      "#D_tampinhas_jogadores"
    );
    ...
    escolha_quantidade_jogadores(
      parseInt(document.getElementById("quantidade_j").innerHTML)
    );
...
btn_Verificar.addEventListener("click", (event) => {
  ...
  verifcar_resposta();
  setTimeout(verificar_ganhador, 1000);
  setTimeout(vez, 1000);
  setTimeout(mostrarNOmes, 1000);
  setTimeout(mostrar_pontos_placar, 1000);
